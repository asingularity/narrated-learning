...
class ExpBrain(object):
    def __init__(self, params):
        ...
        # TODO we need to make an "artificial input" class with random, nosiy events to make sure we can separate out events
        # since first layer input is easily learned anyways ...
        # better yet: make an "ideal" sparse first layer for ball input
        ...
        self.rf_dim = self.im_dim


class ExpBrainOld(object):
#class ExpBrain(object):
    def __init__(self, params):
        self.im_dim = params['image_dim_NxN_pixels']
...
# TODO ********************************************************************************************
class ExpBrainWTALayerPrototype(object):
    '''
    # NOTE this class is deprecated! replacecd by wta_layer_brain.py, where it is now kept and updated!
